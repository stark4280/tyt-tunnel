...
function Page(props) {
  ...
  function renderTextLayer() {
    ...
    return (0, import_jsx_runtime10.jsx)(TextLayer, {}, `${pageKey}_text`);
  }
  function renderAnnotationLayer() {
    if (!renderAnnotationLayerProps) {
      return null;
    }
    return (0, import_jsx_runtime10.jsx)(AnnotationLayer, {}, `${pageKey}_annotations`);
  }
  function renderChildren() {
